...
while i < max_adjectives:
      adjective.append(input("Enter a random adjective: "))
      i += 1


verb = []
verb.append(input("Enter a random verb1: "))
verb.append(input("Enter a random verb2: "))
...
max_nouns = 4
while i < max_nouns:
      reply = input("Enter a random noun: ")
      while len(reply) < 1:
